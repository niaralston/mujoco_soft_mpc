...
#include "mjpc/tasks/softwalker/softwalker.h"
...
namespace mjpc {
std::string Softwalker::XmlPath() const {
  return GetModelPath("softwalker/task.xml");
}
std::string Softwalker::Name() const { return "Softwalker"; }
...
// --------------------------------------------
void Softwalker::ResidualFn::Residual(const mjModel* model, const mjData* data,
